...
public class TransactionRecordPendingConfirmation extends RecyclerView.Adapter<TransactionRecordPendingConfirmation.TransactionViewHolder> {
    ...
    public class TransactionViewHolder extends RecyclerView.ViewHolder {
        ...
        CardView cardView = (CardView) itemView.findViewById(R.id.transaction_card_view_org);


        // Create a constructor for NewsViewHolder that accepts a View called itemView as a parameter
        public TransactionViewHolder(View itemView) {
            super(itemView);
            cardView = (CardView) itemView.findViewById(R.id.transaction_card_view_org);

            acceptButton = (Button) itemView.findViewById(R.id.accept);
            acceptButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(view.getContext(), "The donor has been notified that their request has been accepted.", Toast.LENGTH_SHORT).show();
            ...
            denyButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(view.getContext(), "The donor has been notified that their request has been denied.", Toast.LENGTH_SHORT).show();
                    NotificationCompat.Builder builder = new NotificationCompat.Builder(view.getContext())
                            .setSmallIcon(R.drawable.connect)
                            .setContentTitle("Request Notification")
    ...
    public TransactionViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        int layoutIdForListItem = R.layout.transaction_card_org;
